...
describe '#hello' do
  ...
  it 'El metodo hello retorna la cadena correcta', points: 30 do
...
describe '#starts_with_consonant?' do
  ...
  it 'clasifica casos verdaderos' , points: 10 do
  ...
  it 'clasifica casos falsos' , points: 10 do
  ...
  it 'funciona en la cadena vacia' , points: 5 do
    expect(starts_with_consonant?('')).to be_falsy
  end
  it 'funciona con elementos que no son letras' , points: 5 do
...
describe '#binary_multiple_of_4?' do
  ...
  it 'clasifica numeros binarios validos' , points: 30 do
  ...
  it 'rechaza numeros binarios no validos' , points: 10 do
